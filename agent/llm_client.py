...
# Send a task to Ollama, force the model to return JSON, parse that JSON, validate it, and return clean Java code strings.
class LLMClient:
    ...
    def generate_code(self, task_prompt):
        prompt = self.build_prompt(task_prompt)
    ...
    def build_prompt(self, task_prompt):
        return f"""
